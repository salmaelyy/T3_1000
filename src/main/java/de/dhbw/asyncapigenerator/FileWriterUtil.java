...
public class FileWriterUtil {
    ...
    public String buildMetaHtml(AsyncAPIData data) {
        ...
        String title = AsyncAPIParseUtils.esc(AsyncAPIParseUtils.nullToDash(data.getTitle()));
        String version = AsyncAPIParseUtils.esc(AsyncAPIParseUtils.nullToDash(data.getVersion()));
        String description = AsyncAPIParseUtils.esc(AsyncAPIParseUtils.nullToDash(data.getDescription()));
        int flowCount = data.getFlows().size();
        int participantCount = participants.size();

        String listItems = participants.stream()
                .map(p -> "<li><code>" + AsyncAPIParseUtils.esc(p) + "</code></li>") //<li><code>Teilnehmername</code></li>
